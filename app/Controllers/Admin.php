...
class Admin extends BaseController
{
    ...
    public function isianDataInduk()
    {
        ...
        $data = [
            ...
            'tab' => 'induk',
            'css' => 'styles-admin-data-induk.css',
            'header' => 'header__mini header__isianInduk',
            'i' => $this->i,
            'usersession' => $usersession,
            'tahun' => $usersession['tahun'],
            'tahunsession' => $this->tahun,
    ...
    public function editDataInduk($induk_id, $kategori_id)
    {
        ...
        $data = [
            ...
            'tab' => 'induk',
            'css' => 'styles-admin-add-datainduk.css',
            'header' => 'header__mini header__editDataInduk',
            'i' => $this->i,
            'usersession' => $usersession,
            'induk' => $datainduk,
            'kategori' => $kategori,
    ...
    public function standar()
    {
        ...
        $data = [
            ...
            'header' => 'header__mini header__standar',
            'i' => $this->i,
            'usersession' => $usersession,
            'standar' => $standar,
    ...
    public function editStandarform($standar_id, $kategori_id)
    {
        ...
        $data = [
            ...
            'header' => 'header__mini header__editStandarForm',
            'i' => $this->i,
            'usersession' => $usersession,
            'standar' => $standar,
            'kategori' => $kategori,
    ...
    public function editIndikatorform($standar_id, $kategori_id, $indikator_id)
    {
        ...
        $data = [
            ...
            'tab' => 'standar',
            'css' => 'styles-admin-add-indikator.css',
            'header' => 'header__mini header__editIndikatorForm',
            'i' => $this->i,
            'usersession' => $usersession,
            'standar' => $standar,
            'kategori' => $kategori,
    ...
    public function autoGenerateDataInduk()
    {
        ...
        $data = [
            ...
            'tab' => 'induk',
            'css' => 'styles-admin-add-indikator.css',
            'header' => 'header__mini header__autoGenerateInduk',
            'i' => $this->i,
            'usersession' => $usersession,
            'tahun' => $usersession['tahun'],
            'tahunsession' => $this->tahun,
    ...
    public function resetPenilaian()
    {
        ...
        $data = [
            ...
            'tab' => 'penilaian',
            'css' => 'styles-admin-add-indikator.css',
            'header' => 'header__mini header__resetPenilaian',
            'i' => $this->i,
            'usersession' => $usersession,
            'tahun' => $usersession['tahun'],
            'tahunsession' => $this->tahun,
    ...
    public function resetDataInduk()
    {
        ...
        $data = [
            ...
            'tab' => 'induk',
            'css' => 'styles-admin-add-indikator.css',
            'header' => 'header__mini header__resetInduk',
            'i' => $this->i,
            'usersession' => $usersession,
            'tahun' => $usersession['tahun'],
            'tahunsession' => $this->tahun,
