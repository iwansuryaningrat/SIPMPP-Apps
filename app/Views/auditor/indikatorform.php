        ...
        <div class="row me-0 align-items-center">
          <div class="col-10">
            <div class="dokumen__prev">
              ...
              <p id="dokumen" class="dokumen__name ellipsis__text">jshddke-dneeeje74843hu-simulasi-perantarahewani.xls
              </p>
            </div>
          </div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    if (ext == "pdf") {
      $("#dokumenIcon").attr("src", "/auditor/img/icon/pdf.png");
    } else if (ext == "doc" || ext == "docx") {
      $("#dokumenIcon").attr("src", "/auditor/img/icon/doc.png");
    } else if (ext == "xls" || ext == "xlsx") {
      $("#dokumenIcon").attr("src", "/auditor/img/icon/xls.png");
    } else if (ext == "ppt" || ext == "pptx") {
      $("#dokumenIcon").attr("src", "/auditor/img/powerpoint.png");
    } else {
      $("#dokumenIcon").attr("src", "/auditor/img/icon/txt.png");
    }
  });
</script>
