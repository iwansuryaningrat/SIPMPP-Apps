      ...
      <div class="col-lg-6 col-md-9 col-sm-8">
        <div class="row me-0 align-items-center">
          ...
          <div class="col-2 px-0">
            <a href="/auditor/download/<?= $datapenilaian['dokumen']; ?>" target="_blank" class="btn btn__dark btn__preview ellipsis__text btn__preview-icon shadow-none" id="previewDokumen">
              <span>Preview</span>
