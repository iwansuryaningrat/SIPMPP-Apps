    ...
    <div class="row mb-3">
      ...
      <div class="col-lg-6 col-md-9 col-sm-8">
        <textarea class="form-control form__control shadow-none" id="indikator" name="indikator" cols="30" rows="3"
          disabled><?= $datapenilaian['nama_indikator']; ?></textarea>
      </div>
    </div>
    <!-- target -->
    <div class="row mb-3">
      ...
      <div class="col-lg-6 col-md-9 col-sm-8">
        <textarea class="form-control form__control shadow-none" name="target" id="target" cols="30" rows="3"
          disabled><?= $datapenilaian['target']; ?></textarea>
      </div>
    </div>
    <!-- kebutuhan data -->
    <div class="row mb-3 mb-sm-4">
      ...
      <div class="col-lg-6 col-md-9 col-sm-8">
        <textarea class="form-control form__control shadow-none" id="kebutuhan-data" name="kebutuhan-data" cols="30"
          rows="3"
          disabled><?= $datapenilaian['nama_induk']; ?></textarea>
      </div>
    </div>
    <!-- satuan -->
    <div class="row mb-3 mb-sm-4">
      ...
      <div class="col-lg-6 col-md-9 col-sm-8">
        <input class="form-control form__control shadow-none" id="satuan" name="satuan" disabled
...
<script>
  ...
  // setting display document
  $(document).ready(function() {
    const fileName = $('#dokumen').text();
    var ext = $.trim(fileName.split('.').pop());
    if (ext == "pdf") {
      $("#dokumenIcon").attr("src", "/auditor/img/icon/pdf.svg");
    } else if (ext == "doc" || ext == "docx") {
      $("#dokumenIcon").attr("src", "/auditor/img/icon/doc.svg");
    } else if (ext == "xls" || ext == "xlsx") {
      $("#dokumenIcon").attr("src", "/auditor/img/icon/xls.svg");
    } else if (ext == "ppt" || ext == "pptx") {
      $("#dokumenIcon").attr("src", "/auditor/img/powerpoint.svg");
    } else if (ext == "jpg" || ext == "jpeg" || ext == "png") {
      $("#dokumenIcon").attr("src", "/auditor/img/icon/image.svg");
    } else if (ext == "") {
      $("#dokumenIcon").attr("src", "/auditor/img/icon/close.svg");
      $("#dokumen").text("Dokumen tidak ditemukan.");
      $("#previewDokumen").attr("href", "");
    } else {
      $("#dokumenIcon").attr("src", "/auditor/img/icon/txt.svg");
    }
  });
</script>
