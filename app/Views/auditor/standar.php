...
<div class="filter__table">
  <div class="nav nav-pills" id="pills-tab" role="tablist">
    <button class="btn filter__btn me-0 me-md-3 shadow-none active nav-link ellipsis__text active"
      id="pills-spmi-penelitian" data-bs-toggle="pill" data-bs-target="#pills-table-spmi-penelitian" type="button"
      role="tab" aria-controls="pills-table-spmi-penelitian" aria-selected="true">
      Penelitian
    </button>
    <button class="btn filter__btn shadow-none nav-link ellipsis__text" id="pills-spmi-pm" data-bs-toggle="pill"
            ...
            <tr>
              ...
              <td>
                <a data-bs-placement="top" title="Lihat"
                  href="/auditor/indikator/<?= $standar['standar_id'] . '/' . $standar['kategori_id'] ?>"
