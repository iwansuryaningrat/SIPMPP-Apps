...
<ul class="nav nav-tabs nav__tabs" id="myTab" role="tablist">
  <li class="nav-item nav__item-tab" role="presentation">
    <button class="nav-link nav__link-tab active ellipsis__text" id="penelitian-tab" data-bs-toggle="tab"
      data-bs-target="#penelitian" type="button" role="tab" aria-controls="penelitian"
      aria-selected="true">Penelitian</button>
  </li>
  <li class="nav-item nav__item-tab" role="presentation">
    <button class="nav-link nav__link-tab ellipsis__text" id="pengabdian-tab" data-bs-toggle="tab"
      data-bs-target="#pengabdian" type="button" role="tab" aria-controls="pengabdian" aria-selected="false">Pengabdian
      Masyarakat</button>
  </li>
</ul>
    ...
    <div class="body__tab">
      ...
      <div class="body__tab-item">
        ...
        <div class="body__tab-item__title">
          <a class="tab-item__link" data-bs-toggle="collapse"
            href="#collapsePEN<?= $stat['kode'] ?>"
            role="button" aria-expanded="false"
            aria-controls="collapsePEN<?= $stat['kode'] ?>">
            <span class="ellipsis__text"><?= $stat['standar'] ?></span>
            <i class="fi-br-angle-down ms-3"></i>
          </a>
        </div>
        <!-- collapse -->
        <div class="collapse collapse__item"
          id="collapsePEN<?= $stat['kode'] ?>">
          <div class="mb-5 pt-3">
            <!-- bar chart standar 1 -->
            <div class="chart__collapse-container mb-4">
              <canvas
                id="barChartPEN<?= $stat['kode'] ?>"></canvas>
            </div>
            ...
            <div class="table__collapse">
              <div class="sipmpp__table">
                <div class="table__unit table-responsive">
                  <table class="table sipmpp__table-content table-hover"
                    id="tableCollapsePEN<?= $stat['kode'] ?>">
  ...
  <div class="tab-pane fade" id="pengabdian" role="tabpanel" aria-labelledby="pengabdian-tab">
    ...
    <div class="body__tab">
      ...
      <div class="body__tab-item">
        ...
        <div class="body__tab-item__title">
          <a class="tab-item__link" data-bs-toggle="collapse"
            href="#collapsePPM<?= $stat['kode'] ?>"
            role="button" aria-expanded="false"
            aria-controls="collapsePPM<?= $stat['kode'] ?>">
            <span class="ellipsis__text"><?= $stat['standar'] ?></span>
            <i class="fi-br-angle-down ms-3"></i>
          </a>
        </div>
        <!-- collapse -->
        <div class="collapse collapse__item"
          id="collapsePPM<?= $stat['kode'] ?>">
          <div class="mb-5 pt-3">
            <!-- bar chart standar 1 -->
            <div class="chart__collapse-container mb-4">
              <canvas
                id="barChartPPM<?= $stat['kode'] ?>"></canvas>
            </div>
