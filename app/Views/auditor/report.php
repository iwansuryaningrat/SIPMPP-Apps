...
<ul class="nav nav-tabs nav__tabs" id="myTab" role="tablist">
  <li class="nav-item nav__item-tab" role="presentation">
    <button class="nav-link nav__link-tab active ellipsis__text" id="penelitian-tab" data-bs-toggle="tab" data-bs-target="#penelitian" type="button" role="tab" aria-controls="penelitian" aria-selected="true">Penelitian</button>
  </li>
  <li class="nav-item nav__item-tab" role="presentation">
    <button class="nav-link nav__link-tab ellipsis__text" id="pengabdian-tab" data-bs-toggle="tab" data-bs-target="#pengabdian" type="button" role="tab" aria-controls="pengabdian" aria-selected="false">Pengabdian
      Masyarakat</button>
  </li>
</ul>
