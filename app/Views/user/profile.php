...
<div class="profile__section">
  ...
  <div class="profile__section-profile shadow__box-sm">
    ...
    <form class="form__profile" id="formChangeInfo" action="/home/editprofile" enctype="multipart/form-data"
      method="POST">
      <!-- foto -->
      <div>
      ...
      <div class="d-flex justify-content-end">
        <button type="submit" class="btn btn__dark shadow-none ellipsis__text" id="btnSubmitChangeInfo">
          Simpan Perubahan
        </button>
      </div>
    </form>
