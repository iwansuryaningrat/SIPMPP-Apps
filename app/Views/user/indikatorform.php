...
<div class="header__main-title">
  <div class="header__main-title__pagination">
    ...
    <a
      href="/home/indikator/<?= $standar['standar_id'] . '/' . $datapenilaian['kategori_id'] ?>">Indikator</a>
    / Form Indikator
  </div>
...
<div class="form__indikator">
  <form method="POST"
    action="/home/saveindikator/<?= $datapenilaian['indikator_id'] . '/' . $tahun . '/' . $datapenilaian['standar_id'] . '/' . $data_user['unit_id'] . '/' . $datapenilaian['kategori_id']; ?>"
    enctype="multipart/form-data" id="formEditIndikator">
    <!-- indikator -->
    <div class="row mb-3">
    ...
    <div class="row mb-3 mb-sm-4">
      ...
      <div class="col-lg-6 col-md-9 col-sm-8">
        <input class="form-control form__control shadow-none"
          ...
          id="hasilInput" name="hasil" required <?php if ($datapenilaian['status'] == 'Dikirim' || $datapenilaian['status'] == 'Diaudit') {
    echo 'disabled';
} ?>
        />
      </div>
    ...
    <div class="row mb-3">
      ...
      <div class="col-lg-6 col-md-9 col-sm-8">
        <textarea class="form-control form__control shadow-none" id="keterangan" cols="30" rows="3" name="keterangan"
          value="<?= $datapenilaian['keterangan']; ?>"
          <?php if ($datapenilaian['status'] == 'Dikirim' || $datapenilaian['status'] == 'Diaudit') {
    echo 'disabled';
    ...
    <div class="row mb-3">
      ...
      <div class="col-lg-6 col-md-9 col-sm-8">
        <textarea class="form-control form__control shadow-none" name="catatan" id="catatan" cols="30" rows="3"
          disabled><?= $datapenilaian['catatan']; ?></textarea>
      </div>
    </div>
    <!-- button -->
    <div class="row">
      <div class="col-lg-9 col-md-12 col-sm-12 button__section">
        <a href="/home/indikator/<?= $standar['standar_id'] . '/' . $datapenilaian['kategori_id'] ?>"
