...
<div class="form__indikator">
  <form method="POST"
    action="/home/saveindikator/<?= $datapenilaian[0]['indikator_id'] . '/' . $tahun . '/' . $datapenilaian[0]['standar_id'] . '/' . $data_user['unit_id'] . '/' . $datapenilaian[0]['kategori_id']; ?>"
    ...
    <div class="row mb-3">
      ...
      <div class="col-lg-6 col-md-9 col-sm-8">
        <textarea class="form-control form__control shadow-none" id="indikator" name="indikator" cols="30" rows="3"
          disabled
          required><?= $datapenilaian[0]['nama_indikator']; ?></textarea>
      </div>
    </div>
    <!-- target -->
    <div class="row mb-3">
      ...
      <div class="col-lg-6 col-md-9 col-sm-8">
        <textarea class="form-control form__control shadow-none" name="target" id="target" cols="30" rows="3" disabled
          required><?= $datapenilaian[0]['target']; ?></textarea>
      </div>
    </div>
    <!-- kebutuhan data -->
...
>>>>>>> f063947e957609936900e1d579a8a043555e0a58
    ...
    <?php } elseif ((int)$datapenilaian[0]['nilai_acuan'] > 1) { ?>
    <div class="row mb-3 mb-sm-4">
    ...
    <div class="row mb-3">
      ...
      <div class="col-lg-6 col-md-9 col-sm-8">
        <textarea class="form-control form__control shadow-none" name="catatan" id="catatan" cols="30" rows="3"
          disabled><?= $datapenilaian[0]['catatan']; ?></textarea>
      </div>
    </div>
    <!-- button -->
    <div class="row">
