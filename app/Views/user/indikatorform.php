...
<div class="form__indikator">
  <form method="POST" action="/home/saveindikator/<?= $datapenilaian['indikator_id'] . '/' . $tahun . '/' . $datapenilaian['standar_id'] . '/' . $data_user['unit_id'] . '/' . $datapenilaian['kategori_id']; ?>" enctype="multipart/form-data" id="formEditIndikator">
    <!-- indikator -->
    <div class="row mb-3">
    ...
    <?php if ((int)$datapenilaian['nilai_acuan'] == 1) { ?>
      <div class="row mb-3">
        ...
        <div class="col-lg-6 col-md-9 col-sm-8">
          <select class="form-select form__select shadow-none" name="hasil" id="hasil" <?php if ($datapenilaian['status'] == 'Dikirim' || $datapenilaian['status'] == 'Diaudit') {
                                                                                          echo 'disabled';
                                                                                        } ?>>
    ...
    <?php } elseif ((int)$datapenilaian['nilai_acuan'] > 1) { ?>
      <div class="row mb-3 mb-sm-4">
        <label for="hasil" class="col-lg-3 col-md-3 col-sm-4 col-form-label form__label">Hasil <span class="color__danger">*</span></label>
        <div class="col-lg-6 col-md-9 col-sm-8">
          <input class="form-control form__control shadow-none" value="<?= $datapenilaian['nilai_input'] ?>" id="hasilInput" name="hasil" required <?php if ($datapenilaian['status'] == 'Dikirim' || $datapenilaian['status'] == 'Diaudit') {
                                                                                                                                                      echo 'disabled';
                                                                                                                                                    } ?> />
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-lg-6 col-md-9 col-sm-8">
          <div class="input-group">
            <input type="file" class="form-control form__control shadow-none" name="dokumen" id="dokumenEmpty" required <?php if ($datapenilaian['status'] == 'Dikirim' || $datapenilaian['status'] == 'Diaudit') {
                                                                                                                          echo 'disabled';
                                                                                                                        } ?> />
        ...
        <div class="col-lg-6 col-md-9 col-sm-8">
          <div class="row me-0">
            ...
            <div class="col-2 px-0">
              <a href="/home/download/<?= $datapenilaian['dokumen']; ?>" target="_blank" class="btn btn__dark btn__preview ellipsis__text btn__preview-icon shadow-none">
                <span>Preview</span>
    ...
    <div class="row mb-3">
      ...
      <div class="col-lg-6 col-md-9 col-sm-8">
        <textarea class="form-control form__control shadow-none" id="keterangan" cols="30" rows="3" name="keterangan" value="<?= $datapenilaian['keterangan']; ?>" <?php if ($datapenilaian['status'] == 'Dikirim' || $datapenilaian['status'] == 'Diaudit') {
                                                                                                                                                                      echo 'disabled';
                                                                                                                                                                    } ?>><?= $datapenilaian['keterangan']; ?></textarea>
      </div>
    </div>
    <!-- catatan -->
    <div class="row mb-3">
