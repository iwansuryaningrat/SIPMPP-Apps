<div class="tab-pane fade" id="pills-chart-indikator-pm" role="tabpanel" aria-labelledby="pills-indikator-pm">
    <div class="indikator__kategori-title">
        <h3 class="mb-lg-2 mb-3">Pengabdian Masyarakat</h3>
        <form action="" method="POST" class="mb-lg-2 mb-3">
    ...
    <div id="PPM<?= $Pengabdian['kode'] ?>Indikator"
        class="PPMIndikator">
        <h5 style="font-weight: 600;"><?= $Pengabdian['standar'] ?>
        </h5>
        <!-- bar chart standar 1 -->
        <div class="chart__indikator-container mb-4">
            <canvas
                id="chartPPM<?= $Pengabdian['kode'] ?>Indikator"></canvas>
        </div>
        ...
        <div class="sipmpp__table">
            <div class="table-responsive">
                <table class="table sipmpp__table-content indikator__tbl table-hover"
                    id="tablePPPM<?= $Pengabdian['kode'] ?>Indikator">
