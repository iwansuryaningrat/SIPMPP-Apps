<div class="tab-pane fade show active" id="pills-chart-indikator-penelitian" role="tabpanel"
    ...
    <div class="indikator__kategori-title">
        <h3 class="mb-lg-2 mb-3">Penelitian</h3>
    ...
    <div id="PEN<?= $Penelitian['kode'] ?>Indikator"
        class="PENIndikator">
        <h5 style="font-weight: 600;"><?= $Penelitian['standar'] ?>
        </h5>
        <!-- bar chart standar 1 -->
        <div class="chart__indikator-container mb-4">
            <canvas
                id="chartPEN<?= $Penelitian['kode'] ?>Indikator"></canvas>
        </div>
        ...
        <div class="sipmpp__table">
            <div class="table-responsive">
                <table class="table sipmpp__table-content indikator__tbl table-hover"
                    id="tablePEN<?= $Penelitian['kode'] ?>Indikator">
