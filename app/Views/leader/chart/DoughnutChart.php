<div class="chart__content-left col-lg-5 col-12">
    <div class="chart__content-dounat shadow__box-sm">
        <h6 id="unitStandar"><?= $data_user['unit'] ?>
        </h6>
        <div class="content-unit__title">
            ...
            <div class="filter__panel">
                <div class="nav nav-pills" id="pills-tab" role="tablist">
                    <button
                        class="btn filter__btn-chart me-0 me-md-3 shadow-none active nav-link ellipsis__text active mb-3"
                    ...
                    <button class="btn filter__btn-chart shadow-none nav-link ellipsis__text mb-3"
                        id="pillsStandarPengabdian" data-bs-toggle="pill" data-bs-target="#pillsChartStandarPengabdian"
                        type="button" role="tab" aria-controls="pillsChartStandarPengabdian" aria-selected="false">
