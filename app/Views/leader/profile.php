            ...
            <div>
                ...
                <div class="input-group input-group__photo">
                    ...
                    <div class="img__input-field">
                        ...
                        <label class="form__label__photo btn btn__dark ellipsis__text" for="photo-profile">Ubah
                            Profile</label>
                        <label id="photo-notice" class="form-text form__text mb-3">
                            Gambar profil Anda sebaiknya memiliki raiso 1:1 dan berukuran tidak lebih dari 2 MB.
                        </label>
                    </div>
                </div>
        ...
        <div class="section-password__border">
            ...
            <form class="form__change__password" id="formChangePassword" action="/editdata/editpassword" method="POST">
                <div class="mb-3 position-relative old__pass">
                    ...
                    <input type="password" class="form-control form__control shadow-none" id="oldPassword"
                        name="oldPassword" autocomplete="off" required />
                    <span id="toggleOldPassword"><i class="fa-solid fa-eye icon__hide__password"
                ...
                <div class="mb-3 position-relative new__pass">
                    <label for="newPassword" class="form-label form__label">Password Baru <span
                            class="color__danger">*</span></label>
                    <input type="password" class="form-control form__control shadow-none" id="newPassword"
                        name="newPassword" aria-labelledby="new-password-notice" autocomplete="off" required />
                    <span id="toggleNewPassword"><i class="fa-solid fa-eye icon__hide__password"
                            title="show password"></i></span>
                ...
                <div class="d-flex justify-content-end">
                    <button type="submit" class="btn btn__light shadow-none ellipsis__text"
