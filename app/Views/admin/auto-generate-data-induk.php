...
<div class="header__main-title">
    <div class="header__main-title__pagination">
        ...
        / <a href="/admin/isianDataInduk">Data Induk</a> / Form Auto Generate
    </div>
...
<div class="form__add__user">
    <form method="POST" action="/savedata/indukgenerator">
        ...
        <!-- data induk -->
        <div class="row mb-3 mb-sm-4">
            <label class="col-lg-3 col-md-3 col-sm-4 col-form-label form__label">Data Induk <span
                    class="color__danger">*</span></label>
            <div class="col-lg-6 col-md-9 col-sm-8 row pe-0">
                <div class="col-lg-6 col-12 pe-lg-2 pe-0 mb-lg-0 mb-3">
                    <select name="dataIndukPenelitian[]" id="dataIndukPenelitian"
                        ...
                        <option
                            value="<?= $penelitian['induk_id'] ?>">
                            <?= $penelitian['nama_induk'] ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col-lg-6 col-12 pe-0">
                    <select name="dataIndukPengabdian[]" id="dataIndukPengabdian"
                        ...
                        <option
                            value="<?= $pengabdian['induk_id'] ?>">
                            <?= $pengabdian['nama_induk'] ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                </div>
