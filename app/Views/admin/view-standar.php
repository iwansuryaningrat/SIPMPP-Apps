                    ...
                    <table class="table table__view-standar__content sipmpp__table-content table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>2019</td>
                                <td>
                                    <a data-bs-placement="top" title="lihat" href="/admin/viewIndikator" class="edit__data__induk__icon me-4"><i class="fa-solid fa-eye"></i></a>
                                    <a data-bs-placement="top" title="Edit" href="#" class="edit__data__induk__icon me-4"><i class="fa-solid fa-pen-to-square"></i></a>
