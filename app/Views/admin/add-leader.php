...
<div class="form__add__user">
    <form method="POST" action="/savedata/addbasicuser/pimpinan" id="formAddLeader">
        <!-- User -->
        ...
        <div class="row">
            <div class="col-lg-9 col-md-12 col-sm-12 button__section">
                ...
                <button type="submit" class="btn form__btn btn__dark shadow-none" id="btnAddLeader">
                    Simpan
                </button>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#btnAddLeader").on("click", () => {
            console.log($("#formAddLeader").valid());
        });
    });
</script>
