                        ...
                        <?php foreach ($standarPEN as $standar) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a data-bs-placement="top" title="Edit" href="/admin/editstandarform/<?= $standar['standar_id'] . '/' . $standar['kategori_id']; ?>" class="edit__data__induk__icon"><i class="fa-solid fa-pen-to-square"></i></a>
                                </td>
                            </tr>
                        <?php $i++;
                        endforeach; ?>
