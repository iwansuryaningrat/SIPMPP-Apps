...
<div class="title__table__add mb-2">
    ...
    <div class="title__body__button">
        <a href="/admin/autoGenerateDataInduk" class="btn shadow-none btn__add btn__generate mb-lg-4 mb-3" role="button">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($indukPEN as $data) : ?>
                            <tr>
                                ...
                                <td><?= $data['kode'] ?></td>
                                <td><?= $data['nama_induk'] ?></td>
                                <td>
                                    <a data-bs-placement="top" title="Delete" href="/deletedata/deleteIsian/<?= $data['tahun'] . '/' . $data['unit_id'] . '/' . $data['induk_id'] . '/' . $data['kategori_id'] ?>" class="delete__data__induk__icon"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php $i++;
                        endforeach; ?>
