...
<div class="header__main-title">
    <div class="header__main-title__pagination">
        ...
        <a href="/admin/viewIndikator/<?= $standar['standar_id'] . '/' . $standar['kategori_id']; ?>">Indikator</a>
        / Form Edit Indikator
    </div>
            ...
            <div class="col-lg-6 col-md-9 col-sm-8">
                <select name="kebutuhan_data" id="kebutuhan_data" class="form-select form__select shadow-none" required>
                    <?php foreach ($induk as $datainduk) : ?>
                        <option value="<?= $datainduk['induk_id']; ?>" <?php if ($indikator['nama_indikator'] == $datainduk['induk_id']) {
                                                                            echo 'selected';
