    ...
    <form method="POST" action="#">
        ...
        <div class="row">
            <div class="col-lg-9 col-md-12 col-sm-12 button__section">
                <a href="/admin/isianDataInduk" class="btn form__btn cancel__btn me-4 shadow-none"
                    role="button">Batal</a>
                <button type="submit" class="btn form__btn btn-danger shadow-none">
                    Reset
                </button>
            </div>
        </div>
