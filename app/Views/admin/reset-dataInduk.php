...
<div class="header__main-title">
    <div class="header__main-title__pagination">
        ...
        / <a href="/admin/isianDataInduk">Data Induk</a> / Reset Data Induk
    </div>
    <div class="header__main-title__subtitle">
        <div class="title__subtitle-desc">
            <h1>Reset Data Induk</h1>
            <p>
                Form untuk me-reset data Induk.
            </p>
        </div>
    </div>
</div>
...
<div class="title__table__add">
    <h4 class="title__body__user">Form Reset Data Induk</h4>
</div>

<!-- form reset data induk -->
<div class="form__add__user">
    <form method="POST" action="/editdata/resetDataInduk">
        <!-- tahun -->
        <div class="row mb-3 mb-sm-4">
            ...
            <div class="col-lg-6 col-md-9 col-sm-8">
                <select name="tahun[]" id="tahun" class="form-select form__select shadow-none" multiple multiselect-search="true" multiselect-select-all="true" multiselect-max-items="3" onchange="console.log(this.selectedOptions)" required placeholder-inputs="Pilih Tahun">
        ...
        <div class=" row">
            <div class="col-lg-9 col-md-12 col-sm-12 button__section">
                <a href="/admin/isianDataInduk" class="btn form__btn cancel__btn me-4 shadow-none" role="button">Batal</a>
