...
<div class="form__add__user">
  <form method="POST" action="/savedata/addbasicuser/auditor" id="formAddAuditor">
    <!-- User -->
    ...
    <div class="row">
      <div class="col-lg-9 col-md-12 col-sm-12 button__section">
        ...
        <button type="submit" class="btn form__btn btn__dark shadow-none" id="btnAddAuditor">
          Simpan
        </button>
      </div>
    </div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $("#btnAddAuditor").on("click", () => {
      console.log($("#formAddAuditor").valid());
    });
  });
</script>
