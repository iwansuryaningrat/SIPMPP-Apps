...
<div class="title__table__add mb-3">
  <h4 class="title__body__user me-3 mb-lg-4 mb-3">Daftar Auditor</h4>
  <a href="/admin/addauditor" class="btn shadow-none btn__add btn__dark mb-lg-4 mb-3">
        ...
        <tr>
          ...
          <td>
            <a data-bs-placement="top" title="Delete"
              href="/admin/deleteUserRoleUnit/<?= $user['email']; ?>/3"
