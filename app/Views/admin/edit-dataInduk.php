...
<div class="form__add__datainduk">
    <form method="POST"
        action="/editdata/updateinduk/<?= $induk['induk_id'] . '/' . $induk['kategori_id']; ?>"
        id="formEditInduk">
        <!-- kategori -->
        <div class="row mb-3 mb-sm-4">
            ...
            <div class="col-lg-6 col-md-9 col-sm-8">
                <select name="kategori_id" id="kategori" class="form-select form__select shadow-none" disabled
                    autocomplete="off">
    ...
    echo 'selected';
        ...
        <div class="row mb-3 mb-sm-4">
            <label for="induk_id" class="col-lg-3 col-md-3 col-sm-4 col-form-label form__label">Id Induk
                <span class="color__danger">*</span></label>
            <div class="col-lg-6 col-md-9 col-sm-8">
                <input class="form-control form__control shadow-none" id="induk_id" name="induk_id"
                    value="<?= $induk['induk_id']; ?>"
                    required autocomplete="off" disabled onkeypress="javascript: return validationNumber(event)"
