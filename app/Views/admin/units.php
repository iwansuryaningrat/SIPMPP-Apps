      ...
      <tbody>
        <?php foreach ($units as $unit) : ?>
          <tr>
            ...
            <td>
              <a role="button" data-bs-toggle="modal" data-bs-placement="top" title="Edit" href="#staticBackdrop" class="edit__data__induk__icon me-3 me-md-5" data-dataunit="<?= $unit['nama_unit']; ?>" data-dataidunit="<?= $unit['unit_id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
              <a data-bs-placement="top" title="Delete" href="/deletedata/deleteunit/<?= $unit['unit_id']; ?>" class="delete__data__induk__icon"><i class="fa-solid fa-trash"></i></a>
            </td>
          </tr>
        <?php $i++;
        endforeach; ?>
